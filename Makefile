...
image:
	docker build -t cloudmesh/bookmanager:0.2.14 .

shell:
	docker run --rm -it cloudmesh/bookmanager:0.2.14  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.2.14
...
push:
	docker push cloudmesh/bookmanager:0.2.14

run:
	docker run cloudmesh/bookmanager:0.2.14 /bin/sh -c "cd technologies; git pull; make"
