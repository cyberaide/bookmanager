...
shell:
	docker run --rm -it cloudmesh/bookmanager:0.2.31  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.2.31
...
push:
	docker push cloudmesh/bookmanager:0.2.31
	docker push cloudmesh/bookmanager:latest

run:
	docker run cloudmesh/bookmanager:0.2.31 /bin/sh -c "cd books/book/cloud; git pull; make"
