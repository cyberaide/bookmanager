...
image:
	docker build -t cloudmesh/bookmanager:0.2.10 .

shell:
	docker run --rm -it cloudmesh/bookmanager:0.2.10  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.2.10
...
push:
	docker push cloudmesh/bookmanager:0.2.10

run:
	docker run cloudmesh/bookmanager:0.2.10 /bin/sh -c "cd technologies; git pull; make"
