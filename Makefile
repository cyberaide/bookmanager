...
image:
	docker build -t cloudmesh/bookmanager:0.2.9 .

shell:
	docker run --rm -it cloudmesh/bookmanager:0.2.9  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.2.9
...
push:
	docker push cloudmesh/bookmanager:0.2.9

run:
	docker run cloudmesh/bookmanager:0.2.9 /bin/sh -c "cd technologies; git pull; make"
