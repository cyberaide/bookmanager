...
image:
	docker build -t cloudmesh/bookmanager:0.1.7 .

shell:
	docker run --rm -it cloudmesh/bookmanager:0.1.7  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.1.7
...
push:
	docker push cloudmesh/bookmanager:0.1.7

run:
	docker run cloudmesh/bookmanager:0.1.7 /bin/sh -c "cd technologies; git pull; make"
