...
image:
	docker build -t cloudmesh/bookmanager:0.1.2 .

shell:
	docker run --rm -it cloudmesh/bookmanager:0.1.2  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.1.2
...
push:
	docker push cloudmesh/bookmanager:0.1.2

run:
	docker run cloudmesh/bookmanager:0.1.2 /bin/sh -c "cd technologies; git pull; make"
