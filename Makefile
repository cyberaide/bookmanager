...
image:
	docker build  -t cloudmesh/bookmanager:0.2.23 -t cloudmesh/bookmanager:latest .

shell:
	docker run --rm -it cloudmesh/bookmanager:0.2.23  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.2.23
...
push:
	docker push cloudmesh/bookmanager:0.2.23
	docker push cloudmesh/bookmanager:latest

run:
	docker run cloudmesh/bookmanager:0.2.23 /bin/sh -c "cd technologies; git pull; make"
