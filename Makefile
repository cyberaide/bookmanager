...
image:
	docker build  -t cloudmesh/bookmanager:0.2.28 -t cloudmesh/bookmanager:latest .

shell:
	docker run --rm -it cloudmesh/bookmanager:0.2.28  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.2.28
...
push:
	docker push cloudmesh/bookmanager:0.2.28
	docker push cloudmesh/bookmanager:latest

run:
	docker run cloudmesh/bookmanager:0.2.28 /bin/sh -c "cd books/book/cloud; git pull; make"
