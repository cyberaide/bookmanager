...
image:
	docker build -t cloudmesh/bookmanager:0.2.8 .

shell:
	docker run --rm -it cloudmesh/bookmanager:0.2.8  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.2.8
...
push:
	docker push cloudmesh/bookmanager:0.2.8

run:
	docker run cloudmesh/bookmanager:0.2.8 /bin/sh -c "cd technologies; git pull; make"
