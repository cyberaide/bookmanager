...
image:
	docker build -t cloudmesh/bookmanager:0.1.0 .

shell:
	docker run --rm -it cloudmesh/bookmanager:0.1.0  /bin/bash

cms:
	docker run --rm -it cloudmesh/bookmanager:0.1.0
...
push:
	docker push cloudmesh/bookmanager:0.1.0

run:
	docker run cloudmesh/bookmanager:0.1.0 /bin/sh -c "cd technologies; git pull; make"
