...
image:
	docker build  -t cloudmesh/bookmanager:0.2.32 -t cloudmesh/bookmanager:latest .
...
run:
	docker run cloudmesh/bookmanager:0.2.32 /bin/sh -c "cd books/book/cloud; git pull; make"
